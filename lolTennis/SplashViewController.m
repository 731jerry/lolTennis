...
- (void)loadView {
	...
	splashImageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"SplashView.png"]];
	splashImageView.frame = CGRectMake(0, 0, 320, 480);
	[self.view addSubview:splashImageView];
	
	viewController = [[lolTennisViewController alloc] initWithNibName:@"lolTennisViewController" bundle:[NSBundle mainBundle]];
...
- (void)fadeScreen
{
	...
	[UIView setAnimationDuration:0.65];        // sets animation duration
